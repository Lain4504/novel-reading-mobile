...
import com.miraimagiclab.novelreadingapp.ui.components.BaseDialog
import com.miraimagiclab.novelreadingapp.ui.components.CheckBoxListItem
...
fun AddBookToBookshelfDialog(
    ...
    BaseDialog(
        ...
        Column(
            Modifier.width(IntrinsicSize.Max).sizeIn(maxHeight = 350.dp).verticalScroll(scrollState)
        ) {
