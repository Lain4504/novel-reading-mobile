...
class SettingState(
    ...
    val customBackgroundImageUserData = userDataRepository.stringUserData(UserDataPath.Reader.CustomBackgroundImage.path)
    ...
    val paletteColorUserData = userDataRepository.intUserData(UserDataPath.Reader.PaletteColor.path)
    ...
    val customBackgroundImage by customBackgroundImageUserData.safeAsState("")
    val backgroundImageDisplayMode by backgroundImageDisplayModeUserData.safeAsState("fixed")
    val paletteColor by paletteColorUserData.safeAsState(0)
